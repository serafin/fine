...
class f_paging extends f_c
{
    ...
    public function uriParam($sUriParam = null); // Ustala/pobiera nazwe parametru zadania w kotrym
                                                 // jest przechowywany numer aktualnej strony

    public function param($asKey, $sValue = null); // Dodatkowe parametry
    public function isParam($sKey);                // np. dla f_v_helper_paging mozna podac `width`
