...
/**
 * @todo
 * - w hiddenie caly path przekazywac
 */
class c_form
{
    ...
    public function add2Action()
	{
        ...
        if (isset($_POST['cancel'])) {
            $this->flash('Canceled.')->redirect(array('example', 'list'));
        }
	...
	public function editAction()
	{
        ...
        if ($_POST) {
			...
			if ($_FILES && !f_upload::_()->image()->error()) {
				$form->img->val(f_upload_tmp::_()->create()->pathOption('80x80'));
			}
        ...
        if (isset($_POST['cancel'])) {
            $this->redirect(array('example', 'list'));
        }
